INSERT into Account VALUES (1,'administrator','admin','$2a$10$YMnPqErss2bsF9DYvqNdleNTPpazB4bxprmQFgRYdnBEXoUvPuOXK');
INSERT into Account VALUES (2,'klient','user','$2a$10$b9d7/8kKSWPNa6C.Grooe.7F3IxiIaS9ZGCkbl7MWXOuRznVllRBi');
INSERT into Account VALUES (3,'klient','marekm','$2a$10$O4l2PbTrI6UmdzZU7kduIeG2031OJtjeGKaJmdGU/TRoosSTa1kkm');
INSERT into Account VALUES (4,'klient','mateuszm','$2a$10$rZ9xggsnICAMKshKeH37N.UhFVp8xkgzfWln4R6BZSpUcKwfFTiSW');
INSERT into Account VALUES (5,'klient','damianl','$2a$10$FUvNb.ycFNjH.fG6xPcEI.G//QoN/4dHvWPP3ruOPlMXi18N.OaKu');
INSERT into Account VALUES (6,'pracownik_biurowy','pracownik1','$2a$10$rm8l4atEUoK09OJQ6rMr2uHoaURK8rOwogbIrdpBiob6rbTzrl1Au');
INSERT into Account VALUES (7,'pracownik_biurowy','pracownik2','$2a$10$dHzIY7DUhEzszd70.lIr8uWl2MntnaWE5gxitIqWaN9SYiicsC6mO');
INSERT into Account VALUES (8,'mechanik','pracownik3','$2a$10$PA4rrLTqOPKg3jyGY5BEt.2YAk5/MyW.AzqY4GZ8icKnXwHO6t/2m');
...
INSERT INTO EMPLOYEE VALUES (1,'admin@aso.pl','Andrze','83121244324','36376423','Kowalsk',1);
INSERT INTO EMPLOYEE VALUES (2,'pracownik1@aso.pl','Andrzej','83121244364','363764235','Kowalski',6);
INSERT INTO EMPLOYEE VALUES (3,'pracownik2@aso.pl','Janusz','73121277539','865346856','Stefańczyk',7);
INSERT INTO EMPLOYEE VALUES (4,'pracownik3@aso.pl','Marian','74121277539','465346856','Tak',8);
